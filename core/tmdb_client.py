...
class TMDBClient:
    ...
    def search_tv(self, query: str, year: Optional[int] = None) -> List[TMDBSeriesInfo]:
        """
    ...
    def search_movie(self, query: str, year: Optional[int] = None) -> List[TMDBMovieInfo]:
        """
        Search for movies.
    ...
    def search_series(self, query: str) -> Optional[TMDBSeriesInfo]:
        """
    ...
    @lru_cache(maxsize=200)
    def search_movie_single(self, query: str, year: Optional[int] = None) -> Optional[TMDBMovieInfo]:
        """
    ...
    def get_series_details(self, series_id: int) -> Optional[TMDBSeriesInfo]:
    ...
    def get_movie_details(self, movie_id: int) -> Optional[TMDBMovieInfo]:
    ...
    def get_season(self, series_id: int, season_number: int) -> Optional[TMDBSeasonInfo]:
        """
    ...
    def _parse_series_basic(self, data: Dict) -> Optional[TMDBSeriesInfo]:
    ...
    def _parse_series_full(self, data: Dict) -> Optional[TMDBSeriesInfo]:
    ...
    def _parse_movie_basic(self, data: Dict) -> Optional[TMDBMovieInfo]:
    ...
    def _parse_movie_full(self, data: Dict) -> Optional[TMDBMovieInfo]:
...
class TMDBFilenameGenerator:
    ...
    def generate_series_folder(self, series_name: str) -> Optional[str]:
...
def lookup_series(name: str) -> Optional[TMDBSeriesInfo]:
    """Convenience function to look up a series."""
    return get_tmdb_client().search_series(name)


def lookup_movie(name: str, year: Optional[int] = None) -> Optional[TMDBMovieInfo]:
    """Convenience function to look up a movie."""
    return get_tmdb_client().search_movie_single(name, year)


def get_episode_title(series: str, season: int, episode: int) -> Optional[str]:
