...
class VideoMetadata:
    ...
    source: Optional[str] = None   # BluRay, WEB-DL, HDRip
    codec: Optional[str] = None    # x264, x265, HEVC
    audio: Optional[str] = None    # DTS, AAC, etc.
...
class AIMetadataExtractor:
    ...
    def _regex_extract_video(self, filename: str) -> Optional[VideoMetadata]:
    ...
    def _regex_extract_music(self, filename: str) -> Optional[MusicMetadata]:
    ...
    def _ai_extract_video(self, filename: str) -> Optional[VideoMetadata]:
...
{"title": "string", "year": number or null, "media_type": "movie" or "series", "season": number or null, "episode": number or null, "quality": "string or null", "source": "string or null", "language": "string or null"}"""
    ...
    def _ai_extract_music(self, filename: str) -> Optional[MusicMetadata]:
...
def extract_video_metadata(filename: str, api_key: Optional[str] = None) -> VideoMetadata:
...
def extract_music_metadata(filename: str, api_key: Optional[str] = None) -> MusicMetadata:
