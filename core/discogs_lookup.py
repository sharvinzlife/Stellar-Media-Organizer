...
class DiscogsAlbumInfo:
    ...
    format: Optional[str] = None  # Vinyl, CD, Digital, etc.
    track_count: int = 0
    discogs_release_id: Optional[int] = None
    discogs_master_id: Optional[int] = None
...
class DiscogsClient:
    ...
    def search_track(self, title: str, artist: str = "") -> Optional[DiscogsTrackInfo]:
        """
    ...
    @lru_cache(maxsize=100)
    def search_album(self, album: str, artist: str = "") -> Optional[DiscogsAlbumInfo]:
        """
    ...
    @lru_cache(maxsize=100)
    def search_artist(self, name: str) -> Optional[DiscogsArtistInfo]:
        """
...
def get_discogs_client(api_token: Optional[str] = None) -> Optional[DiscogsClient]:
...
def lookup_track(title: str, artist: str = "", api_token: Optional[str] = None) -> Optional[DiscogsTrackInfo]:
...
def lookup_album(album: str, artist: str = "", api_token: Optional[str] = None) -> Optional[DiscogsAlbumInfo]:
