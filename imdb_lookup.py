...
class IMDBLookup:
    ...
    def search_series(self, query: str) -> Optional[IMDBSeriesInfo]:
        """
    ...
    def _search_omdb(self, query: str) -> Optional[IMDBSeriesInfo]:
    ...
    def _search_imdb_suggest(self, query: str) -> Optional[IMDBSeriesInfo]:
    ...
    def get_episode_info(self, imdb_id: str, season: int, episode: int) -> Optional[IMDBEpisodeInfo]:
        """
    ...
    def get_series_with_episodes(self, query: str, season: int = None) -> Tuple[Optional[IMDBSeriesInfo], Dict[int, IMDBEpisodeInfo]]:
        """
...
_imdb_lookup: Optional[IMDBLookup] = None
...
def get_imdb_lookup(omdb_api_key: Optional[str] = None) -> IMDBLookup:
...
def lookup_series(name: str, omdb_api_key: Optional[str] = None) -> Optional[IMDBSeriesInfo]:
    """
