...
class VideoConverter:
    ...
    def check_hardware_encoding(self) -> bool:
        ...
        try:
            ...
            logger.exception(f"Failed to check hardware encoding: {e}")
            return False
    ...
    def convert_video_external_gpu(
        ...
        try:
            ...
            while True:
                ...
                if status_response.status_code == 200:
                    ...
                    if status_val == "completed":
                        logger.info("✅ GPU conversion completed!")
                        return {
                            "success": True,
            ...
            logger.exception(f"❌ External GPU error: {e}")
            return {
                "success": False,
                "error": str(e),
                "input_file": str(input_path),
    ...
    def convert_video(
        ...
        try:
            ...
            if self.use_host_ffmpeg:
                logger.info("🖥️🚀 Using HOST ffmpeg with M2 Pro GPU acceleration!")
            ...
            duration_result = subprocess.run(duration_cmd, check=False, capture_output=True, text=True, timeout=60)
            ...
            logger.exception("❌ Conversion timeout (> 1 hour)")
            return {
                "success": False,
